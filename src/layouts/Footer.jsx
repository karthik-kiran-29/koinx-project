  ...
  return (
    <div className="px-6 py-8 bg-white mt-8">
      <div className="mb-8">
        ...
        <div className="flex gap-12 justify-evenly overflow-x-auto pb-4 relative scrollbar-hide">
          {coinsList.map((data) => (
      ...
      <div>
        ...
        <div className="flex gap-12 overflow-x-auto justify-evenly pb-4 relative scrollbar-hide">
          {coinsList.map((data) => (
            <div className="flex-shrink-0 w-56 bg-white rounded-xl border border-gray-100 shadow-sm">
              <MiniChart data={data}/>
            </div>
