...
function Team() {
  return (
    <div className="mx-auto px-4 py-16 bg-white rounded-xl">
      ...
      <div className="space-y-8">
        ...
        <div className="bg-blue-50 rounded-lg p-6 flex flex-col md:flex-row gap-6">
          <div className="flex-shrink-0 w-full md:w-48">
            <img 
              src="src\assets\Team_Section_Sundar.png" 
              alt="John Smith" 
        ...
        <div className="bg-blue-50 rounded-lg p-6 flex flex-col md:flex-row gap-6">
          <div className="flex-shrink-0 w-full md:w-48">
            <img 
              src="src\assets\Team_Section_catty.png" 
              alt="Elina Williams" 
              className="w-32 h-32 rounded-lg object-cover mb-4"
            />
        ...
        <div className="bg-blue-50 rounded-lg p-6 flex flex-col md:flex-row gap-6">
          <div className="flex-shrink-0 w-full md:w-48">
            <img 
              src="src\assets\Team_Section_oran.png" 
              alt="John Smith" 
              className="w-32 h-32 rounded-lg object-cover mb-4"
            />
            <h3 className="text-xl font-semibold">John Smith</h3>
